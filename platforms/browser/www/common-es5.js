(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    /***/
    "./src/app/Config/api-config.service.ts":
    /*!**********************************************!*\
      !*** ./src/app/Config/api-config.service.ts ***!
      \**********************************************/
    ...
    /***/
    function srcAppConfigApiConfigServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var ApiConfigService = function ApiConfigService() {
        _classCallCheck(this, ApiConfigService);

        this.api_url = "https://bidmoz.thehereitis.com/bidmoz_app_apis";
      };

      ApiConfigService.ctorParameters = function () {
        return [];
      };

      ApiConfigService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], ApiConfigService);
      /***/
    },
    ...
    function srcAppApiServiceServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_Config_api_config_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! src/app/Config/api-config.service */
      "./src/app/Config/api-config.service.ts");

      var ApiServiceService = /*#__PURE__*/function () {
        function ApiServiceService(http, appConfig) {
        ...
        _createClass(ApiServiceService, [{
          ...
          value: function userRegister(data) {
            console.log("userRegister:", data); // const httpOptions = {
          ...
          key: "getCoupons",
          value: function getCoupons(user_id) {
          ...
          value: function getfeatureProductDetails(id) {
            console.log(id);
          ...
          value: function updateCouponPaymentDetails(data) {
            console.log(data);
      ...
      ApiServiceService.ctorParameters = function () {
        return [{
          ...
          type: src_app_Config_api_config_service__WEBPACK_IMPORTED_MODULE_3__["ApiConfigService"]
        }];
      };
